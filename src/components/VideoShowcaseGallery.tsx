      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 lg:px-12 relative z-10">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4 mb-8">
          ...
          >
            {/* Indicador animado */}
            <div 
              className="absolute h-[calc(100%-12px)] top-1.5 rounded-full shadow-lg transition-all duration-300 ease-out z-0 pointer-events-none"
              style={{
                left: selectedServiceType === 'all' ? '6px' : 
                      selectedServiceType === 'cancion' ? 'calc(33.33% + 6px)' : 
                      'calc(66.66% + 6px)',
                width: 'calc(33.33% - 12px)',
                backgroundColor: selectedServiceType === 'all' ? '#ffffff' : 
                                 selectedServiceType === 'cancion' ? '#fbbf24' : '#22d3ee'
              }}
            />
